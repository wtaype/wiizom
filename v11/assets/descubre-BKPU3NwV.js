import"./vendor-gzd0YkcT.js";const c=(s,a,i,e)=>`
  <div class="des_crd">
    <div class="des_ico" style="background:var(${e})">${s}</div>
    <h3 class="des_tit">${a}</h3>
    <p class="des_des">${i}</p>
  </div>
`,d=[["🌍","Relojes Personalizados","Añade tus ciudades favoritas y consulta la hora mundial al instante","--success"],["📅","Calendario Inteligente","Organiza eventos y reuniones con zonas horarias automáticas","--info"],["💾","Datos Sincronizados","Guarda tu información en la nube y accede desde cualquier dispositivo","--warning"],["🔔","Notificaciones Smart","Recibe alertas personalizadas para tus eventos importantes","--mco"],["📊","Estadísticas Avanzadas","Analiza tus patrones de uso y optimiza tu productividad","--success"],["🔐","Seguridad Total","Tus datos protegidos con encriptación de última generación","--error"]],t=async()=>`
  <div class="des">
    <div class="des_hro">
...
`,o=()=>{console.log("🚀 Descubre inicializado")},n=()=>{console.log("🚀 Descubre limpiado")};export{n as cleanup,o as init,t as render};
