import{j as c}from"./vendor-gzd0YkcT.js";import{v as i,c as a,b as s,a as e,l as o}from"./wii-qN7z5j68.js";import{w as t}from"./main-BccrCoFm.js";import"./main-DbX1ET-j.js";const f=()=>`
  <div class="acerca_container">
    ...
    <div class="acerca_section">
      ...
      <div class="section_content">
        <p><strong>${a}</strong> es una plataforma innovadora diseñada para simplificar el procesamiento de datos. Nació en ${s} con una misión clara: <strong>hacer el trabajo con números más eficiente y accesible</strong> para todos.</p>
        <p>Utilizamos <strong>Tesseract.js</strong> para reconocimiento óptico de caracteres (OCR) de alta precisión, y algoritmos optimizados para cálculos automáticos. Ya seas contador, emprendedor, estudiante o cualquier profesional que trabaje con datos, ${a} está aquí para facilitar tu vida.</p>
    ...
    <div class="acerca_section">
      <h2 class="section_title">
        <i class="fas fa-lightbulb"></i> ¿Por qué ${a}?
      </h2>
    ...
    <div class="acerca_section">
      ...
      <div class="version_timeline">
        <div class="version_item">
          <div class="version_badge current">${i}</div>
          <div class="version_content">
            <h3>Versión ${i} - Actualización Mayor</h3>
        ...
        <div class="version_item">
          ...
          <div class="version_content">
            ...
            <p class="version_date"><i class="far fa-calendar"></i> ${s}</p>
            <ul>
              <li>🎉 Lanzamiento oficial de ${a}</li>
      ...
      <div class="developer_card">
        ...
        <div class="developer_info">
          ...
          <div class="developer_links">
            ...
            <button class="dev_link copy_email" data-email="${e}@hotmail.com">
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${s}-${new Date().getFullYear()} ${a}. Hecho con <i class="fas fa-heart"></i> por ${e}</p>
        <p class="footer_version">Versión actual: <strong>${i}</strong></p>
      </div>
    </div>
  </div>
`,p=()=>{c(".copy_email").on("click",function(){const l=c(this).data("email");t(l,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${a} ${i} cargado`)},u=()=>{c(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{u as cleanup,p as init,f as render};
