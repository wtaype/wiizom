import{j as e}from"./vendor-gzd0YkcT.js";import{v as c,c as a,b as s,a as i,l as o}from"./wii-D1Sx6FkQ.js";import{w as r}from"./main-CTv7P8rM.js";import"./main-kSlV8ypO.js";const f=()=>`
  <div class="acerca_container">
    ...
    <div class="acerca_section">
      ...
      <div class="section_content">
        <p><strong>${a}</strong> es una herramienta revolucionaria diseñada para hacer tu vida más fácil. Nació en ${s} con una misión clara: <strong>democratizar la conversión de medios</strong> y hacerla accesible para todos.</p>
        <p>Nuestra plataforma utiliza la tecnología más avanzada de <strong>FFmpeg</strong> para garantizar conversiones de alta calidad, rápidas y eficientes. No importa si eres creador de contenido, músico, estudiante o simplemente alguien que ama la música, ${a} está aquí para ti.</p>
      ...
      <div class="developer_card">
        ...
        <div class="developer_info">
          ...
          <div class="developer_links">
            ...
            <button class="dev_link copy_email" data-email="${i}@hotmail.com">
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${s}-${new Date().getFullYear()} ${a}. Hecho con <i class="fas fa-heart"></i> por ${i}</p>
        <p class="footer_version">Versión actual: <strong>${c}</strong></p>
      </div>
    </div>
  </div>
`,p=()=>{e(".copy_email").on("click",function(){const l=e(this).data("email");r(l,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${a} ${c} cargado`)},h=()=>{e(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{h as cleanup,p as init,f as render};
