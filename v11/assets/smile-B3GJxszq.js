import"./vendor-gzd0YkcT.js";import{g as i,S as s}from"./main-BE0BGJU7.js";import"./main-DAykFei_.js";let a=i("wiSmile");const r=async()=>`
   <div class="miweb">
    <div class="mhead">
     <div class="mhead_left">
      <h1 class="mh1"><i class="fas fa-trophy"></i> ${s()} ${a.nombre}</h1>
      <ul class="mfeatures">
  ...
  `,o=async()=>{},t=()=>{console.log("😊 Smile limpiado")};export{t as cleanup,o as init,r as render,a as smile};
