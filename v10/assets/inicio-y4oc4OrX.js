import{j as s}from"./vendor-gzd0YkcT.js";const i=()=>`
...
`,c=()=>{s("#btnDemo").on("click",()=>{window.location.href="/convertidor"}),console.log("✅ Inicio cargado")},e=()=>{s("#btnDemo").off(),console.log("🧹 Inicio limpiado")};export{e as cleanup,c as init,i as render};
