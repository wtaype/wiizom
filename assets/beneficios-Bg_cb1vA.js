import{j as t}from"./vendor-gzd0YkcT.js";import{c as i,v as f}from"./wii-D__joMWd.js";import{a as m}from"./main-DNoynWFa.js";import"./main-DzM5mI7l.js";const g=()=>`
  <div class="beneficios_container">
    <div class="beneficios_hero">
      <div class="hero_sparkle">✨</div>
      <h1 class="hero_title">Beneficios Exclusivos de ${i}</h1>
    ...
    <div class="comparison_section">
      <h2 class="section_title">
        <i class="fas fa-balance-scale"></i> ${i} vs Competencia
      </h2>
    ...
    <div class="cta_section">
      <div class="cta_content">
        ...
        <p>Únete a miles de usuarios que ya disfrutan de ${i}</p>
  ...
  <div id="modalRapido" class="wiModal">
    <div class="modalBody" style="background:var(--wb)">
      ...
      <div style="padding:3vh 2vw;text-align:center">
        ...
        <p style="color:var(--tx);line-height:1.8">Nuestra tecnología optimizada con FFmpeg 6.0 permite procesar videos en tiempo récord. Sin importar el tamaño del archivo, ${i} mantiene velocidades consistentes gracias al procesamiento paralelo avanzado.</p>
      </div>
    </div>
  </div>
  ...
  <div id="modalGratis" class="wiModal">
    <div class="modalBody" style="background:var(--wb)">
      ...
      <div style="padding:3vh 2vw;text-align:center">
        ...
        <p style="color:var(--tx);line-height:1.8">Sin límites artificiales, sin muros de pago, sin anuncios invasivos. Creemos que las herramientas útiles deben ser accesibles para todos. ${i} es y siempre será completamente gratuito.</p>
      </div>
    </div>
  </div>
`,y=()=>{t(".benefit_btn").on("click",function(){const a=t(this).data("modal");m(a)});const d=()=>{t(".stat_number").each(function(){const a=t(this),s=parseInt(a.data("count")),r=2e3,c=60,n=s/c;let l=0;const v=setInterval(()=>{l+=n,l>=s?(a.text(s.toLocaleString()),clearInterval(v)):a.text(Math.floor(l).toLocaleString())},r/c)})},e=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(d(),e.disconnect())})},{threshold:.5}),o=document.querySelector(".stats_section");o&&e.observe(o),console.log(`✅ Beneficios de ${i} ${f} cargados`)},_=()=>{t(".benefit_btn").off(),console.log("🧹 Beneficios limpiados")};export{_ as cleanup,y as init,g as render};
