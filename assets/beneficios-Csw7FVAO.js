import{j as f}from"./vendor-gzd0YkcT.js";import{c as t,v as m}from"./wii-qN7z5j68.js";import{a as u,c as h}from"./main-BccrCoFm.js";import"./main-DbX1ET-j.js";const s=f,_=()=>`
  <div class="beneficios_container">
    <div class="beneficios_hero">
      <div class="hero_sparkle">✨</div>
      <h1 class="hero_title">Beneficios Exclusivos de ${t}</h1>
    ...
    <div class="comparison_section">
      <h2 class="section_title">
        <i class="fas fa-balance-scale"></i> ${t} vs Competencia
      </h2>
    ...
    <div class="cta_section">
      <div class="cta_content">
        ...
        <p>Únete a miles de usuarios que ya disfrutan de ${t}</p>
  ...
  <div id="modalGratis" class="wiModal">
    <div class="modalBody" style="background:var(--wb)">
      ...
      <div style="padding:3vh 2vw;text-align:center;font-family:var(--ff_P)">
        ...
        <p style="color:var(--tx);line-height:1.8">Sin límites artificiales, sin muros de pago, sin anuncios invasivos. Creemos que las herramientas útiles deben ser accesibles para todos. ${t} es y siempre será completamente gratuito.</p>
      </div>
    </div>
  </div>
`,x=()=>{s(".benefit_btn").on("click",function(){const a=s(this).data("modal");u(a)}),s(".modalX").on("click",function(){s(this).closest(".wiModal").attr("id",(a,i)=>(h(i),i))});const c=()=>{s(".stat_number").each(function(){const a=s(this),i=parseInt(a.data("count")),r=2e3,d=60,n=i/d;let e=0;const v=setInterval(()=>{e+=n,e>=i?(a.text(i.toLocaleString()),clearInterval(v)):a.text(Math.floor(e).toLocaleString())},r/d)})},o=new IntersectionObserver(a=>{a.forEach(i=>{i.isIntersecting&&(c(),o.disconnect())})},{threshold:.5}),l=document.querySelector(".stats_section");l&&o.observe(l),console.log(`✅ Beneficios de ${t} ${m} cargados`)},k=()=>{s(".benefit_btn, .modalX").off(),console.log("🧹 Beneficios limpiados")};export{k as cleanup,x as init,_ as render};
